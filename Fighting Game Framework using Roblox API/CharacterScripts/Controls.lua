...
local controls = {
	button1 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button1.Value)],
	button2 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button2.Value)],
	button3 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button3.Value)],
	button4 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button4.Value)],
	button5 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button5.Value)],
	button6 = Enum.KeyCode[string.upper(script.Parent.Parent.Controls.Button6.Value)]
